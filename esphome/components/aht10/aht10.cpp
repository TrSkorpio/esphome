...
static const uint8_t AHT10_DEFAULT_DELAY = 75;     // ms, for initialization and temperature measurement
static const uint8_t AHT10_READ_DELAY = 75;       // ms, time to wait for conversion result
